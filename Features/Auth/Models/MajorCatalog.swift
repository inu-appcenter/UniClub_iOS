...
enum MajorCatalog {
    ...
    // MARK: - 학부생 쌍 (Component 283/366 기준 — 쌍 사이 구분선)

    static let undergradPairs: [MajorColumnPair] = [
        .init(id: "pair1",
            left:  .init(id: "humanities", title: "인문대학", items: [
            ...
            right: .init(id: "natural_science", title: "자연과학대학", items: [
        ...
        .init(id: "pair2",
            left:  .init(id: "social_science", title: "사회과학대학", items: [
            ...
            right: .init(id: "global", title: "글로벌정경대학", items: [
        ...
        .init(id: "pair3",
            left:  .init(id: "engineering", title: "공과대학", items: [
            ...
            right: .init(id: "it", title: "정보기술대학", items: [
        ...
        .init(id: "pair4",
            left:  .init(id: "business", title: "경영대학", items: [
            ...
            right: .init(id: "arts", title: "예술체육대학", items: [
                .init(code: "KOREAN_PAINTING",  display: "조형예술학부"),
        ...
        .init(id: "pair5",
            left:  .init(id: "education", title: "사범대학", items: [
            ...
            right: .init(id: "urban", title: "도시과학대학", items: [
        ...
        .init(id: "pair6",
            left:  .init(id: "life_science", title: "생명과학기술대학", items: [
                .init(code: "LIFE_SCIENCE",           display: "생명과학전공"),
                .init(code: "MOLECULAR_LIFE_SCIENCE", display: "분자의생명전공"),
                .init(code: "BIOTECHNOLOGY",          display: "생명공학전공"),
                .init(code: "NANO_BIOTECHNOLOGY",     display: "나노바이오공학전공"),
            ]),
            right: .init(id: "convergence", title: "융합자유전공대학", items: [
        ...
        .init(id: "pair7",
            left:  .init(id: "northeast_asia", title: "동북아국제통상물류학부", items: [
            ...
            right: .init(id: "law", title: "법학부", items: [
                .init(code: "LAW", display: "법학부"),
            ])
        ),
    ]

    // MARK: - 대학원생 쌍 (Component 365 기준)

    static let graduatePairs: [MajorColumnPair] = [
        .init(id: "grad_pair1",
            left:  .init(id: "grad_hum", title: "인문사회계열", items: [
                ...
                .init(code: "URBAN_PLANNING_POLICY",                   display: "도시계획·정책학과"),
                .init(code: "EARLY_CHILDHOOD_FOREST_NATURE_EDUCATION", display: "유아·숲·자연교육학과"),
            ...
            right: .init(id: "grad_nat", title: "자연과학계열", items: [
        ...
        .init(id: "grad_pair2",
            left:  .init(id: "grad_eng", title: "공학계열", items: [
                ...
                .init(code: "CLIMATE_INTERNATIONAL_COOPERATION",                 display: "기후국제협력학과"),
                .init(code: "URBAN_CONVERGENCE_COMPLEX",                         display: "도시융·복합학과"),
                .init(code: "INTELLIGENT_SEMICONDUCTOR_ENGINEERING",             display: "지능형반도체공학과"),
                .init(code: "ARTIFICIAL_INTELLIGENCE",                           display: "인공지능학과"),
                .init(code: "FUTURE_MOBILITY",                                   display: "미래모빌리티학과"),
                .init(code: "BIO_HEALTH_CONVERGENCE",                            display: "바이오헬스융합학과"),
            ...
            right: .init(id: "grad_arts", title: "예술체육계열", items: [
        ...
        .init(id: "grad_pair3",
            left:  .init(id: "grad_edu", title: "교육계열", items: [
            ...
            right: .init(id: "grad_empty", title: "", items: [])
        ),
    ]

    // MARK: - Flat list (코드 조회용)

    static let all: [MajorItem] = {
        let pairs = undergradPairs + graduatePairs
        return pairs.flatMap { [$0.left.items, $0.right.items].flatMap { $0 } }
    }()
}
